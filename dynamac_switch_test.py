...
#%%
#latency_final_th, xput_final_th, prot_arr_th, simEvents_post_th = DynaMAC_somac_test(
#    num_n=num_n, num_p=num_p, duration=duration,simEvents=simEvents,mac_init=0,
#    somac_en=1,window_size=window_size,opt_type = 0)
#
#latency_final_l, xput_final_l, prot_arr_l, simEvents_post_l = DynaMAC_somac_test(
#    num_n=num_n, num_p=num_p, duration=duration,simEvents=simEvents,mac_init=1,
#    somac_en=1,window_size=window_size,opt_type = 1)
...
plt.xlabel('interation no',fontsize=16)
