...
#                            reward = reward
                    ...
                    QLearningEGreedy.update_qtable(reward, g_dt)
                    decision = QLearningEGreedy.decision(protid)
...
#            somac = QlearningBoltzmann(protid)
        decision = mode
        output = []
        self.decision, self.g_dt = self.result_calc(metric, minmax, mode, g_dt)
